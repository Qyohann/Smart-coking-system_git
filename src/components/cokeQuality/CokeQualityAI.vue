            ...
            <pl-table @selection-change="handleSelectionChange" :row-style="tableRowClassName" ref='CoalTable' :data='coalList' big-data-checkbox highlight-current-row :row-height="40" use-virtual border :header-cell-style="{background:'white',color:'#494949',textAlign:'center', border:'1px solid #BFBFBF',fontSize: '14px'}" :height="height" :key='Math.random()' :default-sort="{prop: 'id', order: 'ascending'}" size='mini' :cell-style="{padding:'0px',fontSize: '14px'}" fixedColumnsRoll>
               ...
               <pl-table-column align="center" label='序号' width="80px" prop='id' key="1" fixed ></pl-table-column>
                ...
                <pl-table-column align="center" label='焦炭质量预测值(人工智能算法)' prop='predicted_type' key="Math.random()">
                    <pl-table-column align="center" label='CRI' prop='predicted_CRI' key="Math.random()" width="105px"></pl-table-column>
                    <pl-table-column align="center" label='CSR' prop='predicted_CSR' key="Math.random()" width="105px"></pl-table-column>
                    <pl-table-column align="center" label='M10' prop='predicted_M10' key="Math.random()" width="105px"></pl-table-column>
                    <pl-table-column align="center" label='M25' prop='predicted_M25' key="Math.random()" width="105px"></pl-table-column>
                </pl-table-column>
            </pl-table>
